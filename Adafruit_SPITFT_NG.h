...
#ifndef _Adafruit_SPITFT_NG_H_
#define _Adafruit_SPITFT_NG_H_
...
/*!
  @brief  Adafruit_SPITFT_NG is an intermediary class between Adafruit_GFX
          ...
          the comments.
*/
class Adafruit_SPITFT_NG : public Adafruit_GFX_NG {
...
public:
  ...
  Adafruit_SPITFT_NG(uint16_t w, uint16_t h, int8_t cs, int8_t dc, int8_t mosi,
  ...
  Adafruit_SPITFT_NG(uint16_t w, uint16_t h, int8_t cs, int8_t dc,
                  int8_t rst = -1);
  ...
  Adafruit_SPITFT_NG(uint16_t w, uint16_t h, SPIClass *spiClass, int8_t cs,
  ...
  Adafruit_SPITFT_NG(uint16_t w, uint16_t h, tftBusWidth busWidth, int8_t d0,
  ...
  */
  ...
  using Adafruit_GFX_NG::drawRGBBitmap; // Check base class first
  ...
  // Adafruit_SPITFT_NG_Macros.h. Some have been made into inline functions
...
#endif // end _Adafruit_SPITFT_NG_H_
