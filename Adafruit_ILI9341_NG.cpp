...
*/
/**************************************************************************/
Adafruit_ILI9341_NG::Adafruit_ILI9341_NG(int8_t cs, int8_t dc, int8_t rst)
    : Adafruit_SPITFT_NG(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT, cs, dc, rst) {}
...
/*!
    ...
    @param  busWidth  If tft16 (enumeration in Adafruit_SPITFT_NG.h), is a
...
*/
/**************************************************************************/
void Adafruit_ILI9341_NG::invertDisplay(bool invert) {
...
*/
/**************************************************************************/
void Adafruit_ILI9341_NG::scrollTo(uint16_t y) {
  uint8_t data[2];
  data[0] = y >> 8;
  data[1] = y & 0xff;
 ...
 */
/**************************************************************************/
void Adafruit_ILI9341_NG::setScrollMargins(uint16_t top, uint16_t bottom) {
