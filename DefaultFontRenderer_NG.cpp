...
DefaultFontRenderer_NG::DefaultFontRenderer_NG(const GFXfont *font, int16_t w, int16_t h) : FontRenderer(w, h) {
    gfxFont = font;
    textWindowed = false;
...
*/
/**************************************************************************/
void DefaultFontRenderer_NG::drawChar(Adafruit_GFX_NG &gfx, int16_t x, int16_t y, unsigned char c,
...
void DefaultFontRenderer_NG::getTextBounds(const char *string, int16_t x, int16_t y, int16_t *x1,
...
void DefaultFontRenderer_NG::getTextBounds(const __FlashStringHelper *s, int16_t x, int16_t y,
